Config = {
    'doc_dir_path': 'F:\\学校事务\\python办公测试\\doc文件',
    'docx_dir_path': 'F:\\学校事务\\python办公测试\\docx文件',

    'excel_path': 'F:\\学校事务\\python办公测试\\取出.xlsx',
    ...
    # 需要插入的位置的列号
    'result_excel_path': 'F:\\学校事务\\python办公测试\\存入.xlsx', # 需要存放excel的的文件目录
